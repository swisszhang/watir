...
module Watir
  ...
  module EventuallyPresent
    ...
    def when_present(timeout = nil)
      warn "#when_present would likely be unnecessary if Watir#relaxed_locate? were set to true" unless Watir.relaxed_locate?
      warn '#when_present has been deprecated; use #wait_until_present if a wait is still needed'
    ...
    def when_enabled(timeout = nil)
      warn "#when_enabled would likely be unnecessary if Watir#relaxed_locate? were set to true" unless Watir.relaxed_locate?
      warn '#when_enabled has been deprecated; use #wait_until(&:enabled?) if a wait is still needed'
