  ...
  class Element
    ...
    def wait_for_exists
      ...
      begin
        ...
        unless Watir.default_timeout == 0
          warn "This code has slept for the duration of the default timeout waiting for an Element to exist. "\
                  "If the test is still passing, consider using Element#exists? instead of rescuing this error"
        end
    ...
    def wait_for_present
      ...
      begin
        ...
        unless Watir.default_timeout == 0
          warn "This code has slept for the duration of the default timeout waiting for an Element to be present. "\
                  "If the test is still passing, consider using Element#present? instead of rescuing this error"
        end
    ...
    def element_call(exist_check = :wait_for_exists)
      Wait.timer ||= Wait::Timer.new.tap { |t| t.end_time = ::Time.now + Watir.default_timeout }
      send exist_check
      yield
